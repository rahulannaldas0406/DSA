...
for word in arr:
    ...
    value = sorted(word)
    signature = "".join(value)
    
   
    if signature in dict1:
       
        dict1[signature].append(word)
    else:
        
        dict1[signature] = [word]
